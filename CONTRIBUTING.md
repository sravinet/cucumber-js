...
* `pnpm test` - Compile typescript and run the tests

If everything passes, you're ready to hack! ⛏

## Tests

Type `pnpm run` or see the `package.json` scripts section for how to run each category of tests.

* lint - `pnpm run lint`
  * [prettier](https://github.com/prettier/prettier)
  * [eslint](https://eslint.org/)
  * [dependency-lint](https://github.com/charlierudolph/dependency-lint)
* typescript tests - `pnpm run types-test`
  * [tsd](https://github.com/SamVerschueren/tsd)
* unit tests - `pnpm run unit-test`
  * [mocha](https://mochajs.org/)
  * [chai](https://www.chaijs.com/)
  * [sinon](https://sinonjs.org/)
* compatibility kit - `pnpm run cck-test`
  * checking that cucumber-js emits the [correct messages](https://github.com/cucumber/compatibility-kit)
* feature tests - `pnpm run feature-test`
  * cucumber-js tests itself

## Exports

The functionality exposed under both the `@cucumber/cucumber` and `@cucumber/cucumber/api` entry points is analysed and has a report generated by [API Extractor](https://api-extractor.com/). If you make a change that affects the exported API surface, you'll need to run `pnpm run exports-update` to run the analysis and regenerate the file, and commit the changes. If you forget to do this locally, the CI build will fail and remind you. 
